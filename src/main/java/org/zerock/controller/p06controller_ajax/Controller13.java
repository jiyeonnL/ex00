...
public class Controller13 {
	...
	public String method01() {
		System.out.println("cont13 met01 일 함.");
	...
	public String method04() {
		...
		return "hello this is Date only";
	}
	...
	public String method07() {
		...
		return "random:" + (int)(Math.random()*10) + 1;
	}
	
	@RequestMapping("/met08")
	@ResponseBody
	public String method08() {
		System.out.println("cont13 met08 일함");
		return "hello met08";
	}
	...
	public String method09() {
		System.out.println("cont13 met09 일함");
		return "hello met09";
	}
