...
<button id="btn05">/cont13/metbb 존재하지 않는 경로 요청 보냈을 때 alert("요청실패")</button> <br>
...
<p id="result08"></p>  <br>
<button id="btn09">/cont13/met08 요청완료 시 complete 실행</button>  <br>
<button id="btn10">/cont13/met09 요청완료 시 success/error AND complete 실행</button>  <br>
